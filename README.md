...
-   [4 Use](#use)
    ...
    -   [4.4 ‘rcompiler’ function:](#rcompiler-function)
    -   [4.5 ‘link\_again’ function:](#link_again-function)
    -   [4.6 ‘rnews’ function:](#rnews-function)
...
-   [**OpenBLAS**](https://www.openblas.net/) versions tested: 0.3.0,
    ...
    0.3.10, 0.3.11 and 0.3.12. These are the values that will be passed
    to `x` in `ropenblas(x)`;
