...
**ropenblas** <a href='logo.png'><img src='logo.png' align="right" height="200" /></a>
...
knitr::include_graphics(path = "img/asciicast/ropenblas.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "img/asciicast/last_version_r.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "img/asciicast/last_version_openblas.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "img/asciicast/rcompiler.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "img/asciicast/link_again.svg")
```
