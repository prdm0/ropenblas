...
knitr::include_graphics(path = "inst/asciicast/ropenblas.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "inst/asciicast/last_version_r.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "inst/asciicast/last_version_openblas.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "inst/asciicast/rcompiler.svg")
```
...
```{r, echo=FALSE}
knitr::include_graphics(path = "inst/asciicast/link_again.svg")
```
